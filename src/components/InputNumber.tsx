...
const InputNumber = ({ isActive, onChangeValue = () => {}, onChangeInput, inputValue, dataTestIdCheckbox, dataTestIdInput }: InputNumberProps) => {
  return (
    <div className={`d-flex align-items-center`}>
      ...
      <div className={`trigger-input-box`} data-testid={dataTestIdCheckbox ?? 'checkbox-box'} style={{ minWidth: 20 }}>
        <input className='checkbox-trigger' defaultChecked={isActive} type="checkbox" onChange={onChangeValue} />
      </div>
    </div>
  )
}
